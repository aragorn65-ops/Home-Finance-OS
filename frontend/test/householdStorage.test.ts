...
test(
  "linkHouseholdToAuthenticatedTenant keeps matching authenticated link",
  async () => {
    const { localStorage } =
      installBrowserStorage();
    const {
...
test(
  "linkHouseholdToAuthenticatedTenant blocks conflicting authenticated link",
  async () => {
    const { localStorage } =
      installBrowserStorage();
    const {
